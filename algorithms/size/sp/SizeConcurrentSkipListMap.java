...
import algorithms.size.sp.core.*;
 ...
 * @since 1.6
 */
public class SizeConcurrentSkipListMap<K,V> implements SizeSet<K, V> {
    /*
                ...
                for (;;) {                       // find insertion point
                    ...
                    if (c < 0 &&
                            NEXT.compareAndSet(b, n,
                                    p = new Node<K,V>(key, value, n, insertInfo = sizeCalculator.createUpdateInfo(UpdateOperations.OpKind.Separated.INSERT)))) {
                        sizeCalculator.updateMetadata(UpdateOperations.OpKind.Separated.INSERT, insertInfo);
                        p.insertInfo = null;
                        z = p;
                        break;
