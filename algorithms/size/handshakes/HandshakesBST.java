...
public class HandshakesBST<K extends Comparable<? super K>, V> implements SizeSet<K, V> {
    //--------------------------------------------------------------------------------
    ...
    @Contended
    private final HandshakeSizeCalculator sizeCalculator = new HandshakeSizeCalculator();

    public HandshakesBST() {
