...
public class HandshakesHashTable<K, V> implements SizeSet<K, V> {
    /**
     ...
     */
    public HandshakesHashTable(int requestedTableSize) {
     ...
     */
    public HandshakesHashTable(int requestedTableSize, Comparator<? super K> comparator) {
    ...
    private V fast_listDoGet(Object key, Node<K, V> head) {
        ...
        while ((n = b.next) != null) {
            ...
            int c;
            K k = n.key;
            if ((v = n.valOrRemoveInfo) == null || v instanceof UpdateInfo || k == null ||
                    (c = cpr(cmp, key, k)) > 0)
                b = n;
            else {
                if (c == 0)
