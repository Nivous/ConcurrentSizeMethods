package algorithms.size.handshakes.core;
...
public class HandshakeSizeCalculator<V> {
     ...
     */
    public HandshakeSizeCalculator() {
    ...
    static {
        try {
            ...
            COUNTERS_SNAPSHOT = l.findVarHandle(
                    HandshakeSizeCalculator.class, "countersSnapshot", CountersSnapshot.class);
        } catch (ReflectiveOperationException e) {
            throw new ExceptionInInitializerError(e);
        }
    }
