...
public class OptimisticSizeHashTable<K, V> implements SizeSet<K, V> {
    /**
     ...
     */
    public OptimisticSizeHashTable(int requestedTableSize, int maxTries) {
        this(requestedTableSize, null, maxTries);
    }
     ...
     */
    public OptimisticSizeHashTable(int requestedTableSize, Comparator<? super K> comparator, int maxTries) {
        ...
        for (;;) {
            ...
            for (;;) {                       // find insertion point
                ...
                if (c < 0){
                    ...
                    try{
                        if (NEXT.compareAndSet(b, n, new Node<K,V>(key, value, n)))
                        {
