 ...
 * @since 1.6
 */
public class BarrierConcurrentSkipListMap<K, V> implements SizeSet<K, V> {
    /*
     ...
     */
    public BarrierConcurrentSkipListMap() {
     ...
     */
    public BarrierConcurrentSkipListMap(Comparator<? super K> comparator) {
    ...
    static {
        try {
            ...
            HEAD = l.findVarHandle(BarrierConcurrentSkipListMap.class, "head", Index.class);
