...
public class StampedLockHashTable<K, V> implements SizeSet<K, V> {
    /**
     ...
     */
    public StampedLockHashTable(int requestedTableSize) {
     ...
     */
    public StampedLockHashTable(int requestedTableSize, Comparator<? super K> comparator) {
