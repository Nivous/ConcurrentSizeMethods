package algorithms.size.locks.stampedlock;
 ...
 *
 * This file applies the size transformation using the locks methodology
...
import algorithms.size.locks.core.LocksSizeCalculator;
 ...
 * @since 1.6
 */
public class StampedLockConcurrentSkipListMap<K, V> implements SizeSet<K, V> {
    /*
    ...
    @Contended
    private final transient LocksSizeCalculator sizeCalculator = new LocksSizeCalculator();
        ...
        for (;;) {
            ...
            if (b != null) {
                ...
                for (;;) {                       // find insertion point
                    ...
                    if (c < 0) {
                        long stamp = sizeCalculator.sl.readLock();
                        try {
                            ...
                            sizeCalculator.sl.unlockRead(stamp);
                        }
                    }
                }
     ...
     */
    public StampedLockConcurrentSkipListMap() {
     ...
     */
    public StampedLockConcurrentSkipListMap(Comparator<? super K> comparator) {
    ...
    static {
        try {
            ...
            HEAD = l.findVarHandle(StampedLockConcurrentSkipListMap.class, "head",
                    Index.class);
